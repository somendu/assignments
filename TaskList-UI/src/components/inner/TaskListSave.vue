   ...
   <div id = 'editor-content' class="mt-2" >
     ...
     <table class="mt-2" border="1" width="100%"> 
      <tr>
        <td>
          <p> Date </p>
          <datepicker placeholder="Select Date" size="40" v-model="value.taskDate" format="dd-MM-yyyy" name="taskDate"></datepicker>
        </td>
      ...
      </tr>      <!-- TODO Add PLus Button here to save multiple line -->
...
export default {
  ...
  methods: {
    ...
    fetch('/api/insertTaskList', {
      ...
      .then(res => {console.log ('Response : ' +res.insertSuccess)}) //TODO Use this response to show notification 
      .catch(error => {
      this.error = error;
