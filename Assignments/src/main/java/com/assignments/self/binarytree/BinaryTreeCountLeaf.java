 ...
 * 
 */
package com.assignments.self.binarytree;
...
public class BinaryTreeCountLeaf {
	...
	public static void main(String[] args) throws Exception { // let's create a binary tree
		...
		bt.root.right.right.right = new BinaryTree.TreeNode("k"); // count all leaf nodes of binary tree using recursion
		...
		// count all leaf nodes of binary tree without
		// recursion
...
class BinaryTree {
	...
	/**
	 * * Java method to calculate number of leaf node in binary tree. * * @param
	 * node * @return count of leaf nodes.
	 */
