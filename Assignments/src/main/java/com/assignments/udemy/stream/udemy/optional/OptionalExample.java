...
public class OptionalExample {
	...
	public static Optional<String> getStudentNameOptional() {
		...
		Optional<Student> studentOptional = Optional.ofNullable(StudentDataBase.studentAdamSupplier.get());
	...
	public static void main(String[] args) {
		...
		if (stringOptional.isPresent()) {
			System.out.println(
					"Student Name is " + stringOptional.get() + " with Length : " + stringOptional.get().length());
		}
	}
