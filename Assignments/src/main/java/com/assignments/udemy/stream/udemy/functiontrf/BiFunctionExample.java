...
public class BiFunctionExample {
	...
	static BiFunction<List<Student>, Predicate<Student>, Map<String, String>> binfunctionGender = (studentList,
			studentPredicate) -> {
	...
	public static void main(String[] args) {
		...
		System.out.println(biFunction.apply(StudentDataBase.getAllStudents(), PredicateStudentExample.psgr));

		System.out.println(biFunction.apply(StudentDataBase.getAllStudents(), PredicateStudentExample.psgn));
