...
public class PredicateAndConsumerExample {
	...
	BiPredicate<Integer, String> bip3 = (gradeLevel, gender) -> gradeLevel >= 3 && gender.equalsIgnoreCase("female");

	BiConsumer<String, List<String>> studentBiConsumer = (name, activities) -> System.out
			.println("Student Name: " + name + " Activities : " + activities);
	...
	public static void main(String[] args) {
		...
		new PredicateAndConsumerExample().printStudentActivities(StudentDataBase.getAllStudents());

		new PredicateAndConsumerExample().printStudentActivitiesFemale(StudentDataBase.getAllStudents());
	}
